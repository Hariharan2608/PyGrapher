...
st.set_page_config(
    page_title="Data Visualization Application",
    page_icon="📊",
...
if default_dataset == 'Campus Requirement Dataset':
    try:
        df = pd.read_csv("Project Dataset/Campus Requirement.csv")
    except Exception as e:
        print(e)   

if default_dataset == 'Carseat Dataset':
    try:
        df = pd.read_csv("Project Dataset/carseats.csv")
    except Exception as e:
        print(e)  

if default_dataset == 'Cereal Dataset':
    try:
        df = pd.read_csv("Project Dataset/cereal.csv")
    except Exception as e:
        print(e)  

if default_dataset == 'Insurance Dataset':
    try:
        df = pd.read_csv("Project Dataset/insurance.csv")
    except Exception as e:
        print(e)  

if default_dataset == 'Iris Dataset':
    try:
        df = pd.read_csv("Project Dataset/IRIS.csv")
    except Exception as e:
        print(e)         

if default_dataset == 'Mtcars Dataset':
    try:
        df = pd.read_csv("Project Dataset/mtcars.csv")
    except Exception as e:
        print(e)

if default_dataset == 'Penguin Dataset':
    try:
        df = pd.read_csv("Project Dataset/Penguins_data.csv")
    except Exception as e:
        print(e)

if default_dataset == 'Pokemon Dataset':
    try:
        df = pd.read_csv("Project Dataset/Pokemon.csv")
    except Exception as e:
        print(e)

if default_dataset == 'Students Dataset':
    try:
        df = pd.read_csv("Project Dataset/students.csv")
    except Exception as e:
        print(e)
        
if default_dataset == 'Students Test Performance Dataset':
    try:
        df = pd.read_csv("Project Dataset/StudentsPerformance.csv")
    except Exception as e:
        print(e)
...
chart_select = st.sidebar.selectbox(
    ...
    options=['None', 'Scatterplots', 'Lineplots', 'Histogram', 'Boxplot', 'Violinplot', 'Piechart', 'Areaplot', 'Heatmap', 'Barchart', 'Contour']
)
