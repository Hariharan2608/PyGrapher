...
st.set_page_config(
    page_title="Data Visualization and Classification Application",
    page_icon="📊",
...
# title of the app
st.title("Data Visualization and Classification")
...
sys = st.radio(
    ...
    options=['Data Visualization','Data Classification']
)

if sys == 'Data Visualization':
